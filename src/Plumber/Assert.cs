...
namespace Plumber
{
  ...
  {
    [Conditional("DEBUG")]
    public static void ArgumentsNotNull(params Expression<Func<object>>[] exprs)
    {
      foreach (var expr in exprs)
        ArgumentNotNull(expr);
    }
      ...
      string rationale)
    {
      ...
      throw new ArgumentNullException(extractParamName(expr), rationale);
    }
